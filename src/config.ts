...
export const LINES_DATASET = new Map([
  ...
  ["15", { code: "15", destinations: ["Collège J. Verne", "Jules Verne", "Hôtel de Ville", "Eude", "Grand Val"] }],
  ["20", { code: "20", destinations: ["Le Chapître", "Hôtel de Ville", "Rue de l'Eglise", "Mairie St Aubin"] }],
