...
export const LINES_DATASET = new Map([
  ...
  ["F1", { code: "01", destinations: ["Pl. de la Ronce", "Boulingrin", "Champlain", "Stade Diochon"] }],
  ...
  ["F5", { code: "05", destinations: ["Lycée Galilée", "Boulingrin"] }],
  ["F6", { code: "06", destinations: ["Les Bouttières", "Gare St-Etienne"] }],
  ["F7", { code: "07", destinations: ["La Pléiade", "Boulingrin"] }],
  ...
  ["15", { code: "15", destinations: ["Jules Verne", "Eude", "Grand Val"] }],
  ...
  ["27", { code: "27", destinations: ["Bel Air", "Champlain", "Théâtre des Arts"] }],
