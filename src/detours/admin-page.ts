...
<div id="detailView" class="detail hidden">
	...
	<aside class="panel">
		...
		<p class="note">Partir d'où la course quitte son itinéraire, y revenir plus loin — ou s'arrêter
			là si la ligne est coupée.</p>
...
(function () {
	...
	function renderPath() {
		...
		// deux boutons d'action des deux réglages au-dessus, qui eux sont toujours actifs.
